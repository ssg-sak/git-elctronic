...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-07-25T21:18:03+09:00 |
...
| 주차 | PARKING_REALTIME_COVERAGE | WARN | 430/3922 matched stations | parking_ev_colocation report |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=33.5m, Daegu traffic (loop3)=40.4m | check_collection_health.py |
| D1 | D1_LIVE_STATUS_DRIFT | WARN | 318.9m | build_d1_snapshot.py |
| D1 | D1_LIVE_UTIC_DRIFT | WARN | D1=437, live=67 | join_utic_incident.py → build_d1_snapshot.py |
...
- `external_review_samples/parking_strong_external_review_sample.csv`: STRONG 주차 공존 후보 20개
...
```text
DA① | offline data validity assessment | 20260725
```
