...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-07-28T13:41:21+09:00 |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=171.2m, Daegu traffic (loop3)=174.8m | check_collection_health.py |
| D1 | D1_LIVE_STATUS_DRIFT | WARN | 153.0m | build_d1_snapshot.py |
| D1 | D1_LIVE_UTIC_DRIFT | WARN | D1=91, live=163 | join_utic_incident.py → build_d1_snapshot.py |
...
```text
DA① | offline data validity assessment | 20260728
```
