...
| | |
|---|---|
| **생성** | 2026-07-25T20:41:44+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-07-25 20:35:47 |
| **틱** | 93 |
| **고유 돌발** | 112 |
...
- 유형: `{'공사·작업(2)': 85, '사고·기타(1)': 26, '기타(5)': 1}`
- 충전소 1km 조인: **67** / 4201 (rate=0.0159)
...
```
DA① | UTIC incident offline report | 20260725
```
