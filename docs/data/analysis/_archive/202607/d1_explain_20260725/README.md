...
| | |
|---|---|
| **기준시각 as_of** | `2026-07-25T14:47:10.172616+09:00` |
...
| 공용 확정 가용 | 공용 중 `has_confirmed_available` | **1,317** (71.1%) |
| 공용 관측 가용률 평균 | 관측된 충전기만 분모 | **0.738** |
...
```text
D1 latest as_of=2026-07-25T14:47:10.172616+09:00
