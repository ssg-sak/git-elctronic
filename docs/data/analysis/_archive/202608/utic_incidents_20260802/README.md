...
| | |
|---|---|
| **생성** | 2026-08-02T09:04:05+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-02 09:01:50 |
| **틱** | 104 |
| **고유 돌발** | 147 |
...
- 유형: `{'공사·작업(2)': 115, '사고·기타(1)': 30, '기타(5)': 2}`
- 충전소 1km 조인: **49** / 4201 (rate=0.0117)
...
```
DA① | UTIC incident offline report | 20260802
```
