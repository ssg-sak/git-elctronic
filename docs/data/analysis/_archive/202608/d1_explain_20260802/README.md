...
| | |
|---|---|
| **기준시각 as_of** | `2026-08-02T08:37:18+09:00` |
...
| 공용 확정 가용 | 공용 중 `has_confirmed_available` | **1,426** (77.0%) |
| 공용 관측 가용률 평균 | 관측된 충전기만 분모 | **0.81** |
...
```text
D1 latest as_of=2026-08-02T08:37:18+09:00
