...
| | |
|---|---|
| **생성** | 2026-08-01T08:54:56+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-01 08:54:26 |
| **틱** | 103 |
| **고유 돌발** | 146 |
...
- 유형: `{'공사·작업(2)': 115, '사고·기타(1)': 30, '기타(5)': 1}`
- 충전소 1km 조인: **108** / 4201 (rate=0.0257)
...
```
DA① | UTIC incident offline report | 20260801
```
