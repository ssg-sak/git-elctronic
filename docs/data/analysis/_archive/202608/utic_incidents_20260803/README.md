...
| | |
|---|---|
| **생성** | 2026-08-03T08:59:09+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-03 08:40:55 |
| **틱** | 105 |
| **고유 돌발** | 164 |
...
- 유형: `{'공사·작업(2)': 132, '사고·기타(1)': 30, '기타(5)': 2}`
- 충전소 1km 조인: **537** / 4201 (rate=0.1278)
...
```
DA① | UTIC incident offline report | 20260803
```
