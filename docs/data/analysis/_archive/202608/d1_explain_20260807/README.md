...
| | |
|---|---|
| **기준시각 as_of** | `2026-08-07T13:12:12+09:00` |
...
| 공용 확정 가용 | 공용 중 `has_confirmed_available` | **1,481** (79.9%) |
| 공용 관측 가용률 평균 | 관측된 충전기만 분모 | **0.825** |
...
```text
D1 latest as_of=2026-08-07T13:12:12+09:00
