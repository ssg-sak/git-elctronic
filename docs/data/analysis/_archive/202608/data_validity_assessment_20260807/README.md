...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-08-07T16:20:57+09:00 |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=32.9m, Daegu traffic (loop3)=32.1m | check_collection_health.py |
...
```text
DA① | offline data validity assessment | 20260807
```
