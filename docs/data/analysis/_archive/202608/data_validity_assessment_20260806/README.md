...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-08-06T20:48:31+09:00 |
...
| 주차 | PARKING_REALTIME_COVERAGE | WARN | 425/3922 matched stations | parking_ev_colocation report |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=33.8m, Daegu traffic (loop3)=44.8m | check_collection_health.py |
...
```text
DA① | offline data validity assessment | 20260806
```
