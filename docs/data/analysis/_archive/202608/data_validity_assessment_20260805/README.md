...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-08-05T22:29:43+09:00 |
...
| --- | --- | --- | --- | --- |
| 상태 | STATUS_DUPLICATE_KEY | FAIL | 56 | 동일 tick 내 상태 키의 유일성 |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=38.0m, Daegu traffic (loop3)=47.2m | check_collection_health.py |
...
```text
DA① | offline data validity assessment | 20260805
```
