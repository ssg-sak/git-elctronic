...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-08-09T08:48:01+09:00 |
...
| 주차 | PARKING_OCCUPANCY_FORMULA | WARN | 1/108 | 잔여면과 점유율의 수식 일관성 |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=38.1m, Daegu traffic (loop3)=43.3m | check_collection_health.py |
...
```text
DA① | offline data validity assessment | 20260809
```
