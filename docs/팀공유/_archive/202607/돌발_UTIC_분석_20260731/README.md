...
| | |
|---|---|
| **생성** | 2026-07-31T15:29:12+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-07-31 15:29:04 |
| **틱** | 102 |
| **고유 돌발** | 145 |
...
- 유형: `{'공사·작업(2)': 114, '사고·기타(1)': 30, '기타(5)': 1}`
- 충전소 1km 조인: **647** / 4201 (rate=0.154)
...
```
DA① | UTIC incident offline report | 20260731
```
