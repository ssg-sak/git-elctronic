...
| | |
|---|---|
| **기준시각 as_of** | `2026-07-24T12:19:49.772328+09:00` |
...
| 공용 확정 가용 | 공용 중 `has_confirmed_available` | **1,334** (72.0%) |
| 공용 관측 가용률 평균 | 관측된 충전기만 분모 | **0.782** |
| 이용강도 붙은 소 | `history_observed` / usage_level | **200** |
| 주차 1km 매칭 | team5 PIS | **2,170** |
| 돌발 1km 매칭 | UTIC | **435** |
...
```text
D1 latest as_of=2026-07-24T12:19:49.772328+09:00
