...
| | |
|---|---|
| **생성** | 2026-08-04T09:21:12+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-04 09:01:54 |
| **틱** | 108 |
| **고유 돌발** | 198 |
...
- 유형: `{'공사·작업(2)': 165, '사고·기타(1)': 30, '기타(5)': 2, '미상': 1}`
- 충전소 1km 조인: **505** / 4201 (rate=0.1202)
...
```
DA① | UTIC incident offline report | 20260804
```
