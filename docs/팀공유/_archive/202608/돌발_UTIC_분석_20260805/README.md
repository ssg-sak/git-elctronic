...
| | |
|---|---|
| **생성** | 2026-08-05T22:29:28+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-05 08:34:01 |
| **틱** | 115 |
| **고유 돌발** | 202 |
...
- 유형: `{'공사·작업(2)': 168, '사고·기타(1)': 30, '기타(5)': 2, '미상': 2}`
- 충전소 1km 조인: **222** / 4201 (rate=0.0528)
...
```
DA① | UTIC incident offline report | 20260805
```
