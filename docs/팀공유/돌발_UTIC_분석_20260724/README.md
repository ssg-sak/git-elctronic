...
| | |
|---|---|
| **생성** | 2026-07-24T13:03:27+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-07-24 13:03:24 |
| **틱** | 76 |
| **고유 돌발** | 87 |
...
- 유형: `{'공사·작업(2)': 66, '사고·기타(1)': 20, '기타(5)': 1}`
- 충전소 1km 조인: **257** / 4201 (rate=0.0612)
...
```
DA① | UTIC incident offline report | 20260724
```
