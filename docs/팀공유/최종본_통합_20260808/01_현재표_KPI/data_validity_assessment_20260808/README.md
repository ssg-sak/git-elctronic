...
| 항목 | 내용 |
|---|---|
| 생성 시각 | 2026-08-08T12:14:48+09:00 |
...
| 수집운영 | DYNAMIC_FILE_FRESHNESS | WARN | EvCharger status (loop1)=41.0m, Daegu traffic (loop3)=43.0m | check_collection_health.py |
...
```text
DA① | offline data validity assessment | 20260808
```
