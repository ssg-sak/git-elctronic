...
| | |
|---|---|
| **생성** | 2026-08-08T12:14:38+09:00 |
| **원천** | `docs/data/loops/loop2` UTIC CSV |
| **구간** | 2026-07-21 09:21:28 ~ 2026-08-07 13:31:33 |
| **틱** | 117 |
| **고유 돌발** | 232 |
...
- 틱당 대구 건수: 대략 **13** (median)
- 유형: `{'공사·작업(2)': 192, '사고·기타(1)': 34, '기타(5)': 4, '미상': 2}`
- 충전소 1km 조인: **942** / 4201 (rate=0.2242)
...
```
DA① | UTIC incident offline report | 20260808
```
